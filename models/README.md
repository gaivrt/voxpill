...
- `asr/model.int8.onnx`: primary static Paraformer Chinese/English recognizer,
  243,371,218 bytes,
  SHA-256 `f36a0433bcf096bd6d6f11b80a3ac8bed110bdca632fe0d731df8d1a84475945`.
- `punctuation/model.int8.onnx`: primary Chinese/English CT-Transformer punctuation,
  75,519,198 bytes,
